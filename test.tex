...
momentum distribution under the assumption that the latter has a diagonal
covariance matrix. We would set the stepsizes $\epsilon_i$ individually for each
covaraite as 
\[ \epsilon_i  = \eta (\frac{\partial^2 H}{\partial x^2})^{-\frac{1}/{2}}\]
